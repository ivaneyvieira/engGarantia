...
open class KAppLayoutTopLayout(): AppLayoutRouterLayout<Top?>() {
  ...
  protected fun layout(title: String = "", icon: String = "",
                       block: (@VaadinDsl AppLayoutBuilder<Top>).  () -> Unit): Top {
    val appLayoutBuild = AppLayoutBuilder.get(Top::class.java)
    if(title != "")
  ...
  protected fun AppLayoutBuilder<Top>.bar(block: (@VaadinDsl AppBarBuilder).() -> Unit = {}): FlexLayout {
  ...
  protected fun AppLayoutBuilder<Top>.menu(title: String = "", version: String = "",
